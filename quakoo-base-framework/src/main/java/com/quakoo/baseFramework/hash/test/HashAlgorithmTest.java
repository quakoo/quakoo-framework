...
import com.quakoo.baseFramework.hash.HashAlgorithm;
import com.quakoo.baseFramework.hash.KetamaNodeLocator;
...
public class HashAlgorithmTest {
	...
	public static void main(String[] args) {
		...
		KetamaNodeLocator<Node> locator = new KetamaNodeLocator<Node>(allNodes, HashAlgorithm.KETAMA_HASH, VIRTUAL_NODE_COUNT);
		...
		System.out.println("1111213123123::"+locator.getPrimary("111121312312378"));
		System.out.println("1111213123123::"+locator.getPrimary("143512131231225"));
		System.out.println("1111213123123::"+locator.getPrimary("11232131sg12142"));
		System.out.println("1111213123123::"+locator.getPrimary("11232431wg12142"));
		System.out.println("1111213123123::"+locator.getPrimary("1123213aerg12142"));
