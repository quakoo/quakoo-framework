 ...
 * @author sunli
 * @date 2010-8-13
 * @version $Id: JVMMonitor.java 42 2011-08-16 03:00:00Z sunli1223@gmail.com $
 */
public class JVMMonitor {
    ...
    public static String getMonitorStats(String item) {
        if ("load".equals(item)) {
            ...
            StringBuilder sb = new StringBuilder();
            for (Map.Entry<String,MemoryUsage> entry: gcMap.entrySet()) {
