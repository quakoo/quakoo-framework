...
public class NoticeAllQueueDaoImpl extends BaseDaoHandle implements NoticeAllQueueDao, InitializingBean {

    private final static String notice_all_queue_key = "%s_notice_all_queue";
